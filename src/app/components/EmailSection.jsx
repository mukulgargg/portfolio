    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] text-xl mb-4 max-w-md">
          {" "}
          I&apos;m always looking for new opportunities or cool projects, my
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                id="message"
                className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                placeholder="Hope you are doing well, Let's connect for a great opportunity at ..."
              />
            </div>
            <button
              type="submit"
